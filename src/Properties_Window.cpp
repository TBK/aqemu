...
Properties_Window::~Properties_Window() { delete HDD_Info; }
...
void Properties_Window::Set_Floppy(const VM_Storage_Device &fd,
  ...
  if (fd_list.count() < 1) {
    AQDebug("void Properties_Window::Set_Floppy( const VM_Storage_Device &fd, "
            "const QString &name )",
...
void Properties_Window::Set_CD_ROM(const VM_Storage_Device &cd,
  ...
  if (cd_list.count() < 1) {
    AQDebug("void Properties_Window::Set_CD_ROM( const VM_CDROM &cd, const "
            "QString &name )",
...
void Properties_Window::on_CB_CDROM_Devices_editTextChanged(
    const QString &text) {
  PW_Storage.Set_File_Name(text);
