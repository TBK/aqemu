...
Convert_HDD_Thread::Convert_HDD_Thread() { Error_Message = ""; }

void Convert_HDD_Thread::Set_Args(const QStringList &args) { Arguments = args; }
...
void Convert_HDD_Image_Window::Conversion_Done(bool ok) {
  if (ok) {
    ...
    QMessageBox::information(this, tr("Information:"),
                             tr("Conversion completed sucessfuly!"));
    accept();
  } else {
    ProgDial->accept();
    Conv_Thread.terminate();
...
void Convert_HDD_Image_Window::Cancel_Convertion() { Conv_Thread.terminate(); }
