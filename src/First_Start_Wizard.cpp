...
void First_Start_Wizard::on_Button_Add_Emulator_Manual_Mode_clicked() {
  ...
  Emul.Set_Version(
      String_To_Emulator_Version(ui.CB_Add_Emulator_Version->currentText()));
  ...
  if (emulatorOptionsWin->exec() == QDialog::Accepted) {
    ...
    ui.CB_Add_Emulator_Version->setEditText(
        Emulator_Version_To_String(Emul.Get_Version()));
  }
...
void First_Start_Wizard::retranslateUi() {
  ...
  ui.Label_Welcome_Text->setText(
      tr("Welcome to the AQEMU settings wizard!\nThis wizard will help you "
         "to choose options AQEMU needs to work correctly. Click on "
         "\"Next\" to go to next page or the \"Back\" button to go to the "
         "previous page."));
  ...
  ui.Label_Find_Emulators->setText(
      tr("To work correctly, AQEMU must find QEMU. To search "
         "automatically, click on \"Search\". If the search can't find "
         "QEMU, you can reconfigure AQEMU later. You can do it in the "
