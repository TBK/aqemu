...
HDD_Image_Info::~HDD_Image_Info() { delete QEMU_IMG_Proc; }

VM::Disk_Info HDD_Image_Info::Get_Disk_Info() const { return Info; }
...
void HDD_Image_Info::Parse_Info(int exitCode, QProcess::ExitStatus exitStatus) {
  ...
  if (info_str.isEmpty()) {
    AQDebug("void HDD_Image_Info::Parse_Info( int exitCode, "
  ...
  if (!RegInfo.exactMatch(info_str)) {
    AQWarning("void QEMU_IMG_Thread::Parse_Info( int exitCode, "
              "QProcess::ExitStatus exitStatus )",
    ...
    if (!RegInfo.exactMatch(info_str)) {
      AQError("void QEMU_IMG_Thread::Parse_Info( int exitCode, "
              "QProcess::ExitStatus exitStatus )",
