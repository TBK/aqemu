...
void Advanced_Settings_Window::done(int r) {
  if (r == QDialog::Accepted) {
    ...
    //	Settings.setValue( "Info/Show_Tab_Info",
    // ui.CH_Show_Tab_Info->isChecked() ? "yes" : "no" );
    Settings.setValue("Info/Show_QEMU_Args",
                      ui.CH_Show_QEMU_Args->isChecked() ? "yes" : "no");
    Settings.setValue("Info/Show_Screenshot_in_Save_Mode",
                      ui.CH_Show_Screenshot_in_Save_Mode->isChecked() ? "yes"
                                                                      : "no");
...
*/
    ...
    if (Settings.status() != QSettings::NoError) {
      AQError("void Settings_Window::on_Button_Box_clicked( QAbstractButton* "
              "button )",
              "QSettings Error!");
    }
...
void Advanced_Settings_Window::on_Emulators_Table_cellDoubleClicked(
    int row, int column) {
