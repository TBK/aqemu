...
public:
  ...
  QStringList Build_Native_Device_Args(VM_Native_Storage_Device device,
                                       bool Build_QEMU_Args_for_Script_Mode);
  QStringList Build_Shared_Folder_Args(VM_Shared_Folder folder, int id,
                                       bool Build_QEMU_Args_for_Script_Mode);
  ...
  // Screenshot
  bool Take_Screenshot(const QString &file_name, int width = -1,
                       int height = -1);
  ...
  void Add_Snapshot(const QString &tag, const QString &name,
                    const QString &desc);
...
private slots:
  ...
  VM_Native_Storage_Device Load_VM_Native_Storage_Device(
      const TXML2QDOM::QDomElement &Second_Element) const;
  VM_Shared_Folder
  Load_VM_Shared_Folder(const TXML2QDOM::QDomElement &Second_Element) const;
  void
  Save_VM_Native_Storage_Device(TXML2QDOM::QDomDocument &New_Dom_Document,
                                TXML2QDOM::QDomElement &Dom_Element,
                                const VM_Native_Storage_Device &device) const;

  void Save_VM_Shared_Folder(TXML2QDOM::QDomDocument &New_Dom_Document,
                             TXML2QDOM::QDomElement &Dom_Element,
...
private:
  ...
  QList<VM_Native_Storage_Device>
      Storage_Devices;     // For QEMU 0.8.2 Device Style
  int native_device_count; // to keep track of the number of native devices when
  ...
  QList<VM_Net_Card_Native>
      Network_Cards_Native; // Native QEMU Network Cards. Max 8
