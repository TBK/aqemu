...
public:
  ...
  bool wasCalled() { return called_dbus; }
  bool successfulInit() { return successful_init; }
  bool isExternal() { return (service == 0); }
  bool isActive();
  bool call(const QString &command, const QList<QVariant> &params,
            bool noblock = true);
  ...
  bool call(const QString &command, Virtual_Machine *vm, const QString &param2,
            bool noblock);
