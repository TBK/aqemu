...
Settings_Widget::Settings_Widget(QTabWidget *tab_widget,
  ...
  if (dir == QBoxLayout::TopToBottom) {
    ...
    app->palette("QWidget").color(QPalette::Midlight)); list->setPalette(pal);
    }*/
  ...
  while ((widget = tab_widget->widget(i)) != nullptr) {
    list->addItem(
...
void Settings_Widget::setCurrentIndex(int i) { list->setCurrentRow(i); }
...
void Settings_Widget::setIconSize(QSize s) { list->setIconSize(s); }
